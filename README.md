...
Para lo cual primero crearemos un diagrama de flujo que permita indicar el proceso del proyecto

DIAGRAMA API

Posteriormente crearemos el diagrama del funcionamiento de Md links para el entendimiento del usuario
